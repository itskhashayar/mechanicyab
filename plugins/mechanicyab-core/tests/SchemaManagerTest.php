...
final class SchemaManagerTest extends TestCase
{
    public function testTableNamesUseRuntimePrefixAndCoreSchemaSet(): void
    {
        ...
        self::assertCount(45, $tables);
    }

    public function testPendingMigrationIsReportedWithoutWordPressRuntime(): void
    {
        $schema = new SchemaManager();
        self::assertSame(['stage-2-core-schema-v1', 'stage-3-reference-schema-v2', 'stage-4-mechanics-schema-v3', 'stage-4-mechanics-support-v4', 'stage-7-reviews-trust-v5', 'stage-8-auth-users-v6', 'stage-9-analytics-v7', 'stage-10-financial-v8', 'stage-10-ledger-v9'], $schema->pendingMigrations());
    }
