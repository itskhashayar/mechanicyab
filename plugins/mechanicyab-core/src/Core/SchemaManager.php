...
final class SchemaManager
{
    ...
    {
        return match (true) {
            $this->currentVersion() < 1 => ['stage-2-core-schema-v1', 'stage-3-reference-schema-v2', 'stage-4-mechanics-schema-v3', 'stage-4-mechanics-support-v4'],
            $this->currentVersion() < 2 => ['stage-3-reference-schema-v2', 'stage-4-mechanics-schema-v3', 'stage-4-mechanics-support-v4'],
            $this->currentVersion() < 3 => ['stage-4-mechanics-schema-v3', 'stage-4-mechanics-support-v4'],
            $this->currentVersion() < 4 => ['stage-4-mechanics-support-v4'],
            default => [],
        };
    }
